...
class GoalViewerHandler(BaseHandler):
    ...
    def get(self):
        ...
        self.response.out.write(template.render('templates/userGoals.html', template_values))
...
class FriendsHandler(BaseHandler):
    ...
    def get(self):
        ...
        self.response.out.write(template.render('templates/friendGoals.html', template_values))
...
class AboutHandler(BaseHandler):
    ...
    def get(self):
        ...
        self.response.out.write(template.render('templates/about.html', template_values))
...
class CookieErrorHandler(BaseHandler):
    ...
    def get(self):
        ...
        self.response.out.write(template.render('templates/cookiesAlert.html', template_values)) 
